...
# Tunables
set_unless[:mysql][:tunable][:key_buffer]          = "16M"
set_unless[:mysql][:tunable][:max_connections]     = "100"
...
set_unless[:mysql][:tunable][:max_allowed_packet]  = "1M"
set_unless[:mysql][:tunable][:thread_stack]        = "64k"
set_unless[:mysql][:tunable][:thread_cache_size]   = "4"
set_unless[:mysql][:tunable][:sort_buffer]         = "64k"
set_unless[:mysql][:tunable][:net_buffer_length]   = "2k"
